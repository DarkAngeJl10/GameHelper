...
IniRead, The_VersionName, %config%, Bottle 3-5, Version
...
{
	The_VersionName := 0
	IniWrite, %The_VersionName%, %config%, Bottle 3-5, Version
}
	...
	if (The_LatestVersion != "") 
	{
		if (The_VersionName != The_LatestVersion) 
		{
			...
			IfMsgBox Yes
			{
				...
				IniWrite, %The_LatestVersion%, %config%, Bottle 3-5, Version
