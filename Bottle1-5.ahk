...
{
	The_VersionName := 0
	IniWrite, %The_VersionName%, %config%, Bottle 1-5, Version
}
...
if (CheckforUpdates != 0) {
	...
	LatestAPI.Send()
	The_LatestVersion := WebIniParse(LatestAPI.ResponseText, "Bottle 1-5")
	...
	if (The_LatestVersion != "") 
	{
		if (The_VersionName != The_LatestVersion) 
		{
			...
			IfMsgBox Yes
			{
				...
				IniWrite, %The_LatestVersion%, %config%, Bottle 1-5, Version
